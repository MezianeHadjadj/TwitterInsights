                        ...
                        if (xhr.readyState == 4) {
                            ...
                            if (Object.keys(result).indexOf("resume_url")) {
                                ...
                                if (result["resume_url"] != null) {
                                    review["Resume_url"] = "<a id='angelist_twitter_url'  target='_blank' href='" + result["resume_url"] + "'>" + result["resume_url"] + "</a>";
                                }
                            }
                            ...
                            if (Object.keys(result).indexOf("angellist_url")) {
                                ...
                                if (result["angellist_url"] != null) {
                                    review["Angellist_url"] = "<a id='angelist_twitter_url' target='_blank' href='" + result["angellist_url"] + "'>" + result["angellist_url"] + "</a>";
                                }
                            }
                            if (Object.keys(result).indexOf("facebook_url")) {
                                review["Facebook_url"] = "";
                                if (result["facebook_url"] != null) {
                                    review["Facebook_url"] = "<a id='angelist_twitter_url' target='_blank' href='" + result["facebook_url"] + "'>" + result["facebook_url"] + "</a>";
                                }
                            }
                            if (Object.keys(result).indexOf("linkedin_url")) {
                                review["Linkedin_url"] = "";
                                if (result["linkedin_url"] != null) {
                                    review["Linkedin_url"] = "<a id='angelist_twitter_url' target='_blank' href='" + result["linkedin_url"] + "'>" + result["linkedin_url"] + "</a>";
                                }
                            }
                            if (Object.keys(result).indexOf("github_url")) {
                                review["Github_url"] = "";
                                if (result["github_url"] != null) {
                                    review["Github_url"] = "<a id='angelist_twitter_url' target='_blank' href='" + result["github_url"] + "'>" + result["github_url"] + "</a>";
                                }
                            }
